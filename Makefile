...
# Project:  src\ThesisBackup.pro
# Template: app
# Command: C:\Qt\5.3\mingw482_32\bin\qmake.exe -spec win32-g++ -o Makefile src\ThesisBackup.pro
#############################################################################
...
Makefile: src/ThesisBackup.pro C:/Qt/5.3/mingw482_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.3/mingw482_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ -o Makefile src\ThesisBackup.pro
